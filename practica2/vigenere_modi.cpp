...
int main() {
  std::string texto = "Este mensaje se autodestruira en cinco segundos";
  std::string clave = "mision";

  std::reverse(clave.begin(), clave.end()); // modificacion
